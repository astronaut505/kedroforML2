...
# spaceflights_homework_ml2 documentation build
...
from spaceflights_homework_ml2 import __version__ as release

# -- Project information -----------------------------------------------------

project = "spaceflights_homework_ml2"
author = "Kedro"
...
htmlhelp_basename = "spaceflights_homework_ml2doc"
...
latex_documents = [
    (
        master_doc,
        "spaceflights_homework_ml2.tex",
        "spaceflights_homework_ml2 Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "spaceflights_homework_ml2",
        "Project spaceflights_homework_ml2 codebase.",
        "Data-Science",
    )
]
